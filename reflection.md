...
I ran `python -m pytest` and got the result — 5 passed. For example, test_guess_too_high checks that guessing 60 against a secret of 50 returns "Too High" AND that the message contains "LOWER", which proves my hint fix works.
